...
class DataPreprocessor:
    ...
    def prepare_features(self, df: pd.DataFrame, target_col: str = 'Survived', 
        ...
        # Define feature columns to keep for modeling
        feature_cols = [
        ...
        # Add Title and Deck features if they exist
